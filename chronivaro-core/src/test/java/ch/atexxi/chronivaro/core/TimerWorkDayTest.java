...
public class TimerWorkDayTest {
	...
	public void shouldManageWorkDayWithTimer() {
		...
		// 1. Start Timer
		ServiceResult startResult1 = serviceHandler.doService(certificate, new StartTimerService(), new StringArgument(employeeId));
		...
		ServiceResult startResult2 = serviceHandler.doService(certificate, new StartTimerService(), new StringArgument(employeeId));
