...
public class EmployeeServiceTest {
	...
	public void shouldCreateUpdateAndRemoveEmployee() {
		...
		// Update
		createArg.displayName = "Updated Employee";
		ServiceResult updateResult = serviceHandler.doService(certificate, new UpdateEmployeeService(), createArg);
