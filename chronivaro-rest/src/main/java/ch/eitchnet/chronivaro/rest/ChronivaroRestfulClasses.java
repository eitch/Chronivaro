...
import ch.eitchnet.chronivaro.rest.providers.ChronivaroAuthenticationRequestFilter;
import ch.eitchnet.chronivaro.rest.providers.ChronivaroRestfulExceptionMapper;
import ch.eitchnet.chronivaro.rest.providers.CorrelationIdFilter;
import ch.eitchnet.chronivaro.rest.resource.*;
...
public class ChronivaroRestfulClasses {
	...
	public static Set<Class<?>> getRestfulClasses() {
		...
		restfulClasses.add(OnCallPeriodResource.class);
